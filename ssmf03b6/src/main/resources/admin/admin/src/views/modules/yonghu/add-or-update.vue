<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用户号" prop="yonghuhao">
          <el-input v-model="ruleForm.yonghuhao" 
              placeholder="用户号" clearable  :readonly="ro.yonghuhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用户号" prop="yonghuhao">
              <el-input v-model="ruleForm.yonghuhao" 
                placeholder="用户号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='yonghuhao'){
            this.ruleForm.yonghuhao = obj[o];
	    this.ro.yonghuhao = true;
            continue;
          }
	            	            if(o=='mima'){
