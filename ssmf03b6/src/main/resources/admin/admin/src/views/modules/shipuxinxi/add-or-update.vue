      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="食谱名称" prop="shipumingcheng">
          <el-input v-model="ruleForm.shipumingcheng" 
              placeholder="食谱名称" clearable  :readonly="ro.shipumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="食谱名称" prop="shipumingcheng">
              <el-input v-model="ruleForm.shipumingcheng" 
                placeholder="食谱名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <el-form-item class="select" v-if="type!='info'"  label="食谱分类" prop="shipufenlei">
          <el-select v-model="ruleForm.shipufenlei" placeholder="请选择食谱分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="食谱分类" prop="shipufenlei">
        ...
        <el-form-item class="input" v-if="type!='info'"  label="烹饪方式" prop="pengrenfangshi">
          <el-input v-model="ruleForm.pengrenfangshi" 
              placeholder="烹饪方式" clearable  :readonly="ro.pengrenfangshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="烹饪方式" prop="pengrenfangshi">
              <el-input v-model="ruleForm.pengrenfangshi" 
                placeholder="烹饪方式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="功效" prop="gongxiao">
          <el-input v-model="ruleForm.gongxiao" 
              placeholder="功效" clearable  :readonly="ro.gongxiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="功效" prop="gongxiao">
              <el-input v-model="ruleForm.gongxiao" 
                placeholder="功效" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="时长" prop="shizhang">
              <el-input v-model="ruleForm.shizhang" 
                placeholder="时长" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="原材料" prop="yuancailiao">
          <el-input v-model="ruleForm.yuancailiao" 
              placeholder="原材料" clearable  :readonly="ro.yuancailiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="原材料" prop="yuancailiao">
              <el-input v-model="ruleForm.yuancailiao" 
                placeholder="原材料" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="搭配禁忌" prop="dapeijinji">
          <el-input v-model="ruleForm.dapeijinji" 
              placeholder="搭配禁忌" clearable  :readonly="ro.dapeijinji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="搭配禁忌" prop="dapeijinji">
              <el-input v-model="ruleForm.dapeijinji" 
                placeholder="搭配禁忌" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                      </el-row>
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="做法" prop="zuofa">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="做法"
                  v-model="ruleForm.zuofa" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zuofa" label="做法" prop="zuofa">
                    <span>{{ruleForm.zuofa}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shipuxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shipuxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
