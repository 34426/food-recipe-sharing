  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(25, 169, 123, 1);fontSize:28px;">美食食谱推荐分享系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.yonghuhao" class="input" type="text" placeholder="用户号">
			   </div>
			 </div> -->
			<el-form-item label="用户号" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.yonghuhao" autocomplete="off" placeholder="用户号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='yonghu'" class="input-group">
...
export default {
  ...
  methods: {
    ...
    // 注册
    login() {
                              if((!this.ruleForm.yonghuhao) && `yonghu` == this.tableName){
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210301/2c03d6eb298345a6a03ac4aca647da23.jpg");
		height: 100vh;
