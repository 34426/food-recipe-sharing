        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="食物功效" prop="shiwugongxiao">
          <el-input v-model="ruleForm.shiwugongxiao" 
              placeholder="食物功效" clearable  :readonly="ro.shiwugongxiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="食物功效" prop="shiwugongxiao">
              <el-input v-model="ruleForm.shiwugongxiao" 
                placeholder="食物功效" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="食物搭配" prop="shiwudapei">
          <el-input v-model="ruleForm.shiwudapei" 
              placeholder="食物搭配" clearable  :readonly="ro.shiwudapei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="食物搭配" prop="shiwudapei">
              <el-input v-model="ruleForm.shiwudapei" 
                placeholder="食物搭配" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="食物禁忌" prop="shiwujinji">
          <el-input v-model="ruleForm.shiwujinji" 
              placeholder="食物禁忌" clearable  :readonly="ro.shiwujinji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="食物禁忌" prop="shiwujinji">
              <el-input v-model="ruleForm.shiwujinji" 
                placeholder="食物禁忌" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='shiwugongxiao'){
            this.ruleForm.shiwugongxiao = obj[o];
	    this.ro.shiwugongxiao = true;
            continue;
          }
	            	            if(o=='shiwudapei'){
            this.ruleForm.shiwudapei = obj[o];
	    this.ro.shiwudapei = true;
            continue;
          }
	            	            if(o=='shiwujinji'){
            this.ruleForm.shiwujinji = obj[o];
	    this.ro.shiwujinji = true;
            continue;
          }
	                    }
                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `cailiaoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.cailiaoxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
