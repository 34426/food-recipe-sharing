<template>
  <div>
    ...
    >  
     <el-row>
                              <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="用户号" prop="yonghuhao">
          <el-input v-model="ruleForm.yonghuhao" readonly              placeholder="用户号" clearable></el-input>
        </el-form-item>
      </el-col>
                                          <el-col :span="12">
...
export default {
  ...
  methods: {
        ...
        this.ruleForm.touxiang = fileUrls;
                                                                                                    ...
                                                                                                    onUpdateHandler() {
                              if((!this.ruleForm.yonghuhao)&& 'yonghu'==this.flag){
