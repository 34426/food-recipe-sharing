        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                                    ...
                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="星期一" prop="xingqiyi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="星期一"
                  v-model="ruleForm.xingqiyi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xingqiyi" label="星期一" prop="xingqiyi">
                    <span>{{ruleForm.xingqiyi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="星期二" prop="xingqier">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="星期二"
                  v-model="ruleForm.xingqier" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xingqier" label="星期二" prop="xingqier">
                    <span>{{ruleForm.xingqier}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="星期三" prop="xingqisan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="星期三"
                  v-model="ruleForm.xingqisan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xingqisan" label="星期三" prop="xingqisan">
                    <span>{{ruleForm.xingqisan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="星期四" prop="xingqisi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="星期四"
                  v-model="ruleForm.xingqisi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xingqisi" label="星期四" prop="xingqisi">
                    <span>{{ruleForm.xingqisi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="星期五" prop="xingqiwu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="星期五"
                  v-model="ruleForm.xingqiwu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xingqiwu" label="星期五" prop="xingqiwu">
                    <span>{{ruleForm.xingqiwu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="星期六" prop="xingqiliu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="星期六"
                  v-model="ruleForm.xingqiliu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xingqiliu" label="星期六" prop="xingqiliu">
                    <span>{{ruleForm.xingqiliu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="星期天" prop="xingqitian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="星期天"
                  v-model="ruleForm.xingqitian" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xingqitian" label="星期天" prop="xingqitian">
                    <span>{{ruleForm.xingqitian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='xingqiyi'){
            this.ruleForm.xingqiyi = obj[o];
	    this.ro.xingqiyi = true;
            continue;
          }
	            	            if(o=='xingqier'){
            this.ruleForm.xingqier = obj[o];
	    this.ro.xingqier = true;
            continue;
          }
	            	            if(o=='xingqisan'){
            this.ruleForm.xingqisan = obj[o];
	    this.ro.xingqisan = true;
            continue;
          }
	            	            if(o=='xingqisi'){
            this.ruleForm.xingqisi = obj[o];
	    this.ro.xingqisi = true;
            continue;
          }
	            	            if(o=='xingqiwu'){
            this.ruleForm.xingqiwu = obj[o];
	    this.ro.xingqiwu = true;
            continue;
          }
	            	            if(o=='xingqiliu'){
            this.ruleForm.xingqiliu = obj[o];
	    this.ro.xingqiliu = true;
            continue;
          }
	            	            if(o=='xingqitian'){
            this.ruleForm.xingqitian = obj[o];
	    this.ro.xingqitian = true;
            continue;
          }
	                    }
                                                                                                                                                              }
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                ...
                                                                                // 多级联动参数
                                                                                                      info(id) {
      this.$http({
        url: `yizhoushipujiankanganpai/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yizhoushipujiankanganpai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yizhoushipujiankanganpaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
